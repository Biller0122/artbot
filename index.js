...
ХАМГИЙН ЧУХАЛ ДУРЭМ:
- Яриа турхийг БУРЭН уншиж, өмнө нь юу ярьсаныг санаж байх.
- Хэрэглэгч хэдэн хун гэж хэлсэн бол тэрийгээ санаж дахин асуухгуй.
- Хэрэглэгч зураг явуулсан бол зургаа явуулаарай гэж ДАХИН хэлэхгуй.
- Зураг ирсэн бол зургийг харж тайлбарлаад дараагийн алхам руу шил.
- Нэг асуулт НЭГ л удаа асуу.
- Яаралтай унэ = ундсэн унэ x 1.2 (бухэл тоо).
- Унэ хэлэхдээ энгийн текстээр бич.
...
Утас авмагц хариуны тогсголд заавал энэ JSON тавь:
      ...
      if (entry.messaging) {
        entry.messaging.forEach(event => {
          if (event.message?.is_echo) {
            ...
            // app_id байхгуй = хун (admin) бичсэн
...
async function handleMessage(event) {
  ...
  // Текст мессежийг яриа түүхэнд нэмэх
...
async function handleOrderImage(senderId, imageUrl) {
  ...
  try {
    ...
    // Зургийг яриа түүхэнд нэмэх — текстийн тайлбартай хамт
    userConversations[senderId].push({
      ...
      content: [
        ...
        {
          type: "text",
          text: "Зургаа явуулсан байна. Энэ зургийг харж өмнөх яриа дээр үндэслэн дараагийн алхмыг хий. Дахин зураг явуулаарай гэж хэлэхгүй.",
        },
      ],
    });
    ...
    // Зургийн хариултыг яриа түүхэнд хадгалах — текст хэлбэрээр
    userConversations[senderId].push({
      role: "assistant",
      content: cleanReply,
    });
